...
if __name__ == "__main__":
    main()
# note
# DP stores as you go and no reduducncy 
# 1.Initialization of the matrix with the scores possible
# initalize first row and column as you go from left to right incrasing gap penaility 
# 2.Matrix filling with maximum scores.
# fill in the remaining rows and columns 
# n+1 and m+1 allows gaphs at the begining of the alignments 
